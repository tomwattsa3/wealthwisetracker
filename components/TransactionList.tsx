...
const TransactionRow: React.FC<TransactionRowProps> = ({
    ...
    return (
        <>
            {/* Mobile Row */}
            <div className={`md:hidden grid grid-cols-[1fr_80px_70px] items-center h-9 text-xs border-b border-slate-100 ${isExcluded ? 'opacity-40' : ''}`}>
                ...
                <span className="px-2 text-[9px] text-slate-400 border-r border-slate-100 truncate">{t.subcategoryName || '-'}</span>
...
const TransactionList: React.FC<TransactionListProps> = ({ transactions, categories, onUpdate, onDelete }) => {
  ...
  return (
    <>
        ...
        {/* Mobile Header */}
        <div className="md:hidden grid grid-cols-[1fr_80px_70px] items-center h-6 text-[9px] font-bold text-slate-400 uppercase border-b border-slate-200 bg-slate-50">
            <span className="px-2 border-r border-slate-200">Merchant</span>
            <span className="px-2 border-r border-slate-200">Sub</span>
